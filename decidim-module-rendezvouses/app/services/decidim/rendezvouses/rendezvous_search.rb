...
module Decidim
  module Rendezvouses
    # This class handles search and filtering of rendezvouses. Needs a
    # `current_feature` param with a `Decidim::Feature` in order to
    # find the rendezvouses.
    class RendezvousSearch < Searchlight::Search
      ...
      def base_query
        Decidim::Rendezvouses::Rendezvous
            .includes(:author)
